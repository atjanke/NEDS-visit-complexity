...
setwd("/Users/alexanderjanke/Data/neds/2009_NEDS")

neds09 <- fread("NEDS_2009_ED.csv")

colnames(neds09) <- c("DISCWT","HCUPFILE","HOSP_ED","KEY_ED","CPT1","CPT2","CPT3","CPT4","CPT5",
...
neds09 <- neds09 %>% select.(KEY_ED,CPT1:CPT15,PRCCSED1:PRCCSED9)

core <- fread("NEDS_2009_Core.csv")
...
source("Functions.R")
neds09 <- EM_Code(neds09)

saveRDS(neds09,"__data-cleaned/neds09.rds")

subsample <- stratified(neds09,c("HOSP_ED"),0.1)
saveRDS(subsample,"__data-cleaned/neds09-subsample.rds")