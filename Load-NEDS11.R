...
setwd("/Users/alexanderjanke/Data/neds/2011_NEDS")

neds11 <- fread("NEDS_2011_ED.csv")
colnames(neds11) <- c("hosp_ed","KEY_ED","CPT1","CPT2","CPT3","CPT4","CPT5","CPT6","CPT7","CPT8","CPT9",
...
neds11 <- neds11 %>% select.(KEY_ED,CPT1:CPT15,PRCCSED1:PRCCSED9)

core <- fread("NEDS_2011_Core.csv")
...
source("Functions.R")
neds11 <- EM_Code(neds11)

saveRDS(neds11,"__data-cleaned/neds11.rds")

subsample <- stratified(neds11,c("HOSP_ED"),0.1)
saveRDS(subsample,"__data-cleaned/neds11-subsample.rds")
