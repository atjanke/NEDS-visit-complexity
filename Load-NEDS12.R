...
setwd("/Users/alexanderjanke/Data/neds/2012_NEDS")

neds12 <- fread("NEDS_2012_ED.csv")
colnames(neds12) <- c("hosp_ed","KEY_ED","CPT1","CPT2","CPT3","CPT4","CPT5","CPT6","CPT7","CPT8","CPT9",
...
neds12 <- neds12 %>% select.(KEY_ED,CPT1:CPT15,PRCCSED1:PRCCSED9)

core <- fread("NEDS_2012_Core.csv")
...
source("Functions.R")
neds12 <- EM_Code(neds12)

saveRDS(neds12,"__data-cleaned/neds12.rds")

subsample <- stratified(neds12,c("HOSP_ED"),0.1)
saveRDS(subsample,"__data-cleaned/neds12-subsample.rds")
