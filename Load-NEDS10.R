...
setwd("/Users/alexanderjanke/Data/neds/2010_NEDS")

neds10 <- fread("NEDS_2010_ED.csv")

colnames(neds10) <- c("DISCWT","HCUPFILE","HOSP_ED","KEY_ED","CPT1","CPT2","CPT3","CPT4","CPT5",
...
neds10 <- neds10 %>% select.(KEY_ED,CPT1:CPT15,PRCCSED1:PRCCSED9)

core <- fread("NEDS_2010_Core.csv")
...
source("Functions.R")
neds10 <- EM_Code(neds10)

saveRDS(neds10,"__data-cleaned/neds10.rds")

subsample <- stratified(neds10,c("HOSP_ED"),0.1)
saveRDS(subsample,"__data-cleaned/neds10-subsample.rds")