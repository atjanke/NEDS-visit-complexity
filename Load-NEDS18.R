...
neds18 <- fread("NEDS_2018_ED.csv")
colnames(neds18) <- c("hosp_ed","KEY_ED","CPT1","CPT2","CPT3","CPT4","CPT5","CPT6","CPT7",
...
neds18 <- neds18 %>% select.(KEY_ED,CPT1:CPT15,PRCCSED1:PRCCSED9)

core <- fread("NEDS_2018_Core.csv")
